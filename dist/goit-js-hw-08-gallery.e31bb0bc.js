...
var galleryMarkup = createGalleryMarkup(_app.default);
var modal = document.querySelector(".js-lightbox");
var bigImage = document.querySelector(".lightbox__image");
galleryList.insertAdjacentHTML('afterbegin', galleryMarkup);
galleryList.addEventListener('click', onImageClick);
modal.addEventListener('click', onCloseModal); //1. Cоздаем разметку, можно через .createElemen, но сейчас вариант через шаблонную строку. И рендерим ее.
...
},{"./app.js":"app.js"}],"index.js":[function(require,module,exports) {
"use strict";

var gallery = _interopRequireWildcard(require("./gallery.js"));
...
},{"./gallery.js":"gallery.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/goit-js-hw-08-gallery.e31bb0bc.js.map